...
| `Feature.AgentMarkdown.Tests.ps1` | Deterministic Markdown default/raw startup, accessible Settings toggle/save, live toggles with process/session preservation, expanded table history/resize/selection, gated streaming text/tool ordering, and CRLF literal-block blank lines. All seven verified on the feature Dev build; C319-C325 checked in full and incremental reports. | 7 |
