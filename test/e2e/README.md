...
| `Feature.AgentMarkdown.Tests.ps1` | Deterministic Markdown default/raw startup, accessible Settings toggle/save, live toggles with process/session preservation, expanded table history/resize/selection, and gated streaming text/tool ordering. All six verified on the feature Dev build; C319-C324 checked in full and incremental reports. | 6 |
