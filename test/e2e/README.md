...
| `Feature.AgentMarkdown.Tests.ps1` | Deterministic Markdown default/raw startup, accessible Settings toggle/save, live toggles with process/session preservation, expanded history, narrow table grids with wrapped cells and selection after resize, gated streaming text/tool ordering, CRLF literal-block blank lines, and task-heading reclassification without helper crashes. | 9 |
